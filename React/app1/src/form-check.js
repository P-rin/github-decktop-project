                    ...
                    style.map((st,i)=>{
                        return(
                            <div className="form-check form-check-inline mb-2">
                                ...
                                <label htmlFor={'check'+i} className="form-check-labal">{st}</label>
                            </div>
                        )
                    })
                }
                    ...
                    sizes.map((sz,i)=>{
                        return(
                            <div className="form-check form-check-inline mb-2">
                                ...
                                className="form-check-input" onChange={onChangeRadio}></input>
                                <label htmlFor={'radio'+i} className="form-check-label">{sz}</label>
                            </div>
                        )
                    })
                }
                <div className="from-check form-switch mt-3">
