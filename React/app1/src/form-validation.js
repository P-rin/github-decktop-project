...
export default function FormValidation() {
    const cats = [['100','ไอดี'],['200','เครื่องจักรกล'],['300','เคมีภัณฑ์']]
        ...
        <div className="mt-3 mb-5 mx-auto p-3 rounded" style={{ width:'400px', background:'#cee'}}>
            <form onSubmit={handleSubmit(onSubmitForm)}>
                ...
                <div className="form-group mb-3">
                    ...
                    {errors.detail && <div style={err}>ต้องกำหนดรายการสินค้า</div>}
                </div>
                <div className="form-group mb-3">
                ...
                <div className="text-center mt-4">
                    <button className="form-control btn-sm px-4">OK</button>
                </div>
            </form>
        </div>
    )
